...
A simple and intuitive todo list application built with vanilla JavaScript, CSS, and HTML. This project demonstrates core web development concepts including DOM manipulation, event handling, and clean code architecture.
...
This Todo List app is a hands-on learning project designed to practice fundamental JavaScript DOM manipulation and event-driven programming. The application allows users to manage their daily tasks efficiently with a clean, user-friendly interface built using Flexbox for responsive layout.
...
See [LEARNINGS.md](./LEARNINGS.md) for detailed learning notes.
